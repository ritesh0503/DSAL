...
void print() { 
	...
	for(i=f;i<=r;i++) {
		...
		switch(Pr[i]) {
			...
			break;
			case 5: cout << " Priority - 'Non-serious' " << endl;
			break;
			case 10: cout << " Priority - 'Serious' " << endl;
			break;
			default: cout << "Priority not found" << endl;
		}
	}
}
...
int main() {
	...
	do {
	cout<<"MAIN MENU"<<endl;
	cout << "1.Insert the Data in Queue" << endl << "2.show the Data in Queue " << endl << "3.Delete the data from the Queue" 
		<< endl << "0 for Exit"<< endl;
	cout<<"Enter Your Choice:-"<<endl;
	cin >> opt;
		switch(opt) {
			case 1: cout << "Enter the number of patinent" << endl;
				cin >> n;
				i = 0;
				while(i < n) {
